...
createdAt: 2026-05-25T15:58:36.349330+00:00
updatedAt: 2026-05-25T15:58:36.349330+00:00
---
...
- **program.md**: A plain English instruction file that defines the research agenda, experimental constraints, and agent operating parameters ^[karpathy-autoresearch-explained-100-experiments-overnight.md]
...
7. **Error Handling**: Crashed experiments prompt log analysis, attempted fixes, and re-execution ^[karpathy-autoresearch-explained-100-experiments-overnight.md]
...
- **Hardware Constraints**: Experiments are designed for single GPU execution with 5-minute time budgets ^[karpathy-autoresearch-explained-100-experiments-overnight.md]
...
- **Simplicity Criterion**: Minor improvements requiring significant code complexity are discouraged to maintain system coherence ^[karpathy-autoresearch-explained-100-experiments-overnight.md]
...
- **Bug Discovery**: Automated detection of implementation errors missed during manual code review, including QK-Norm scalar multiplier issues ^[karpathy-autoresearch-explained-100-experiments-overnight.md]
...
- **Hypothesis Testing Acceleration**: Removes execution bottlenecks for researchers with more ideas than time to test them ^[karpathy-autoresearch-explained-100-experiments-overnight.md]
...
- **Scope Constraints**: Designed for short training experiments rather than complex, long-running research projects ^[autoresearch-by-karpathy-and-the-future-of-autonomous-ai-research.md]
