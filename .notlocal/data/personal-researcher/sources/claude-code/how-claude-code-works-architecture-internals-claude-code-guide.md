---
title: "How Claude Code Works: Architecture & Internals | Claude Code Guide"
source: "https://cc.bruniaux.com/guide/architecture/"
ingestedAt: "2026-05-28T19:44:54Z"
---
...
_Source_ : [Latent Space podcast](https://www.latent.space/p/claude-code) (May 2025), ast-grep documentation
...
_Inspired by[Mohamed Ali Ben Salem’s architecture diagram](https://www.linkedin.com/posts/mohamed-ali-ben-salem-2b777b9a_en-ce-moment-je-vois-passer-des-posts-du-activity-7420592149110362112-eY5a) — See [Architecture Internals diagrams](/guide/04-architecture-internals/) for a deeper breakdown._
...
**Confidence** : 100% (Tier 1 - Official) **Source** : [Anthropic Engineering Blog](https://www.anthropic.com/engineering/claude-code-best-practices)
...
**Confidence** : 100% (Tier 1 - Official) **Source** : [code.claude.com/docs](https://code.claude.com/docs/en/setup)
...
> **📖 Deep Dive** : See [Search Tools Mastery](/guide/search-tools-mastery/) for comprehensive workflows combining all search tools.
...
**Core Components** :
  ...
  * **Safety instructions** : Content policies, refusal patterns (see [Security Hardening](/guide/security-hardening/))
...
This is distinct from compaction drift. Compaction addresses context _size_ ; failure re-injection addresses context _quality_ within a bounded window.
...
**Confidence** : 100% (Tier 1 - Documented behavior) **Source** : [code.claude.com/docs](https://code.claude.com/docs/en/setup) \+ System prompt (visible in tool definitions)
...
**Confidence** : 100% (Tier 1 - Official) **Source** : [code.claude.com/docs/en/sandboxing](https://code.claude.com/docs/en/sandboxing)
...
**Deep dive** : See [Native Sandboxing Guide](/guide/sandbox-native/) for complete technical reference, configuration examples, and troubleshooting.
...
→ **Cross-reference** : See [Section 7 - Hooks](/guide/ultimate-guide/06-commands/#7-hooks) in the main guide for complete examples.

* * *

**Confidence** : 100% (Tier 1 - Official) **Source** : [code.claude.com/docs/en/mcp](https://code.claude.com/docs/en/mcp)
...
→ **Cross-reference** : See [Section 8.6 - MCP Security](/guide/ultimate-guide/08-mcp/#86-mcp-security) for security considerations.

**Status** : Stable (January 26, 2026) **Spec** : [SEP-1865 on GitHub](https://github.com/modelcontextprotocol/ext-apps) **Co-authored by** : OpenAI, Anthropic, MCP-UI creators
...
→ **Cross-reference** : See [Section 8.6 - MCP Security](/guide/ultimate-guide/08-mcp/#86-mcp-security) for broader MCP security considerations.
...
**Confidence** : 100% (Tier 1 - Official) **Source** : [anthropic.com/engineering/advanced-tool-use](https://www.anthropic.com/engineering/advanced-tool-use)
...
**Confidence** : 90% (Tier 1 - Official Anthropic Engineering) **Source** : [Anthropic Engineering: Advanced Tool Use](https://www.anthropic.com/engineering/advanced-tool-use) | [Programmatic Tool Calling Docs](https://platform.claude.com/docs/en/agents-and-tools/tool-use/programmatic-tool-calling)
...
**Confidence** : 80% (Tier 2 - Based on March 2026 fact-checked data) **Sources** : Official documentation, Perplexity research March 2026, vendor changelogs
